...
class SearchResponse(StrictModel):
    ...
    entailment_attempted: bool = Field(default=False, exclude=True)
    entailment_completed: bool = Field(default=False, exclude=True)
    entailment_provider: str = Field(default="none", exclude=True)
    entailment_model: str = Field(default="none", exclude=True)
    entailment_revision: str = Field(default="none", exclude=True)
    entailment_threshold: float = Field(default=0.0, ge=0, le=1, exclude=True)
    entailment_input_count: int = Field(default=0, ge=0, exclude=True)
