...
def test_the_readme_names_source_available_license_and_the_citation_path() -> None:
    ...
    Red proof: this node was run against the pre-change README, which still advertised Apache
    2.0, and failed its first assertion because the new PolyForm license name was absent.
    """
    text = README.read_text(encoding="utf-8")
