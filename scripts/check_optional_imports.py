...
PROFILE_IMPORTS: dict[str, tuple[str, ...]] = {
    ...
    "entail": ("sentence_transformers", "recall.entailment"),
    "eval": ("matplotlib", "numpy"),
    "extract": ("openai", "recall.truth_extraction._openai_engine"),
    "finetune": ("sentence_transformers", "datasets", "accelerate", "numpy"),
    "openai": (
        "openai",
        "recall.embeddings",
        "recall.reasoning_expansion",
        "recall.truth_extraction._openai_engine",
    ),
    "pool": ("psycopg_pool",),
    "rerank": ("sentence_transformers", "recall.rerank"),
    "s3": ("boto3", "recall.manifest"),
    "sparse": ("transformers", "torch", "recall.sparse"),
    "voyage": ("voyageai", "recall.embeddings"),
    "desktop": (
        "PySide6",
        "keyring",
        "mcp",
