...
1. **Ingestion source.** Production refuses local filesystem indexing (`recall_mcp/service.py:3099`, `recall/cli_commands/index_search.py:254` <!-- cite-anchor: env_is_production -->).
