...
| Missing `generation_id` is `null` in `SearchResult`, while the optional explanation labels it `"legacy"` | `recall_mcp/service.py:1038` | confirmed. The two fields intentionally preserve different compatibility contracts |
