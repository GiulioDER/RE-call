...
| `calibration = None` is deliberate, and names an open design question | `recall/cli_commands/index_search.py:561` | confirmed |
...
**Yes, and `recall/cli_commands/index_search.py:561` was right to refuse the version that would have been dishonest.**
