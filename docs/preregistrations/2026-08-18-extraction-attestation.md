...
| Cited | Was | Is now |
|---|---|---|
| `recall/index.py:787` | the `{**extracted.metadata, "media_type": ...}` dict | `recall/index.py:877` |
| `recall/index.py:841` | `text_start` / `text_end` stored as `None` | `recall/index.py:929` |
