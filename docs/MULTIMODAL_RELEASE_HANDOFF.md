...
Workstream 3 is integrated as a release-ready isolated specialist path. No deployment, migration,
...
* The serving adapter keeps the multimodal tenant behind explicit feature enablement and requires
  its own certified generation and embedding profile before federation can execute it.
