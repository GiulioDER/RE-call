...
#: `recall_evidence` and `recall_stats` are `read_only_hint`, `recall_index` is a write,
#: `recall_forget` is `destructive_hint`, so a principal's scopes line up with the risk the tool
#: actually carries.
