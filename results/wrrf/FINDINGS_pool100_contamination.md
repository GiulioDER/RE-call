...
3. **`results/locomo/postfix_pool100.json` should be withdrawn or re-run**, not annotated. The
   precedent is `9eb3bc1`'s own handling of contaminated artifacts: *"an annotated wrong number in
