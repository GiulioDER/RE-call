...
|---|---|---|---|
| §9b LOCOMO abstention, 4 modes | current | `locomo/postfix_abstention.json` | post-#81/#84. `locomo_abstention.py:168` passes `calibration=cal` explicitly, so #101's auto-load bug never reached it (design spec §3) |
